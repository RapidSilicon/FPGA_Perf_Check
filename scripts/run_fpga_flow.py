...
for design in designs_dict:
    ...
    #yosys sim
    yosys_sim_cmd = ('~/symbi_yosys/bin/yosys -p "plugin -i ql-qlf; synth_quicklogic -blif ./designs/'+design_top+'/'+design_top+'.blif -family qlf_k4n8 -top '+design_top+'" ./designs/'+design_top+'/'+design_fname+' -l ./logs/'+design_top+'.log')
